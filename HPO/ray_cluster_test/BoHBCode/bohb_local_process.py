...
if __name__ == "__main__":
    ...
    parser.add_argument('--run_id', type=str, help='A unique run id for this optimization run. An easy option is to use the job id of the clusters scheduler.', default='ex5_11')
    ...
    if args.worker:
        ...
        time.sleep(5)
        w = PyTorchWorker(run_id=args.run_id, host=host, timeout=120)
    ...
    # not plock!
    # Start local worker
    w =PyTorchWorker(run_id=args.run_id, host=host, nameserver=ns_host, nameserver_port=ns_port, timeout=120)
