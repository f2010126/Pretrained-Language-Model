...
class LightningWorker(Worker):
    ...
    def compute(self, config, budget, working_directory, *args, **kwargs):
        ...
        """
        print(f'budget {budget} for config: {config}')
        ...
        train_accuracy = trainer.callback_metrics['ptl/train_accuracy'].item()
        validation_accuracy = trainer.callback_metrics['ptl/val_accuracy'].item()
    ...
    def get_configspace():
        ...
        layer_1_size=CSH.CategoricalHyperparameter('layer_1_size', [32,])
        layer_2_size = CSH.CategoricalHyperparameter('layer_2_size', [256])

        cs.add_hyperparameters([layer_1_size, layer_2_size,])
