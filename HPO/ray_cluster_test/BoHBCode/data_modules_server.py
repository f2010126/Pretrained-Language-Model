...
import numpy as np
import evaluate
from datasets import enable_progress_bar, load_dataset
...
if __name__ == "__main__":
    ...
    test_config['aug']=True
    # central location for the datasets
    test_config['data_dir'] = "/work/dlclarge1/dsengupt-zap_hpo_og/TinyBert/HPO/ray_cluster_test/BoHBCode/tokenized_data/Augmented/miam_1X_10Labels"
