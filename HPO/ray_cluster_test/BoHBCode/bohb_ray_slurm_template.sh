...
python3 bohb_runner.py --max_budget MAX_BUDGET --n_iterations NUM_ITER --n_workers NUM_WORKER --run_id RUN_ID --shared_directory datasetruns --task DATASET_TO_OPTIMSE --eta bohb_eta --num_gpu GPU_WORKERS --previous_run PREV_RUN
wait
echo 'End of Script'
