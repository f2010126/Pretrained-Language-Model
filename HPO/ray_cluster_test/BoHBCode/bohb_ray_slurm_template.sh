...
python3 bohb_runner.py --max_budget MAX_BUDGET --n_iterations NUM_ITER --n_workers NUM_WORKER --run_id Cardiff_115_Runs1 --shared_directory datasetruns --task DATASET_TO_OPTIMSE --eta ETA --num_gpu GPU_WORKERS
wait
echo 'End of Script'
